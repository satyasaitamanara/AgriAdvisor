        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/" className="flex items-center text-green-100 hover:text-amber-200 transition-colors"><ChevronRight size={14} className="mr-1" /> Home</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/" className="flex items-center text-green-100 hover:text-amber-200 transition-colors"><ChevronRight size={14} className="mr-1" /> Blog</Link></li>
